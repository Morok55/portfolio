      ...
      <div className="flex flex-col p-4 justify-center max-w-screen-lg mx-auto h-full">
        <div className="mb-2">
          ...
          <p className="py-6 text-white/90 leading-relaxed">
            Буду рад сотрудничеству и открыт к предложениям. Связаться со мной можно в удобное
            для вас время: пишите в Telegram, отправляйте письмо на почту или звоните по телефону.
          </p>
        </div>
        ...
        <div className="max-w-2xl space-y-4">
          ...
          <div className={`flex items-center justify-between gap-4 p-3 ${glassCard}`}>
            ...
            <button
              type="button"
              onClick={() => doCopy(TELEGRAM_URL, "tg")}
              className={glassBtn}
        ...
        {copied && (
          ...
          >
            ...
            {copied === "tg" && "Ссылка на Telegram скопирована"}
          </div>
        )}
      </div>
    </section>
